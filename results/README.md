...
| [EXP-011](EXP-011.md) | Completed three-seed Qwen k-center, entropy and least-confidence comparisons against matched random controls. |
| [EXP-012](EXP-012.md) | Qwen known-box line recognition: one completed random-seed 0/64/128/192-page baseline. |
